...
settings.version = 'IDS-2018'
settings.name = '100cm_greg'
...
settings.aperture_radius = 0.5  # aperture radius in meters (2.5 meter primary = 1.25m radius)
settings.f_number = 3.0  #
...
settings.use_edge_dB = False # True ## this means calculate pixel sizes from edge taper given earlier.
settings.use_D_px = True  # False ## use D_px from bands.csv import 
...
settings.elements_path = os.path.join(settings.base_path,
                 'inputs/100cm_IDS2018.csv')  # all telescope surfaces, lenses, etc.
...
settings.bands_path = os.path.join(settings.base_path,
                 'inputs/bands_IDS2018.csv')  # csv of bands.
