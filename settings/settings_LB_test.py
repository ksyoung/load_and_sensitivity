...
settings.version = 'LB_test'
settings.name = 'one_band'
settings.verbose =  True # False #

# Telescope/ Receiver Optical Parameters
settings.mult_bands = True  
settings.band = [34.e9,46.e9]  # GHz, lower, upper.  40, width = 30%
...
settings.use_D_px = True ## use D_px from bands.csv import Only works if MCP = True and mult_bands = True
...
settings.elements_path = os.path.join(settings.base_path,
                 'inputs/LB_test.csv')  # all telescope surfaces, lenses, etc.
...
settings.bands_path = os.path.join(settings.base_path,
                 'inputs/LB_test_bands.csv')  # csv of bands.
