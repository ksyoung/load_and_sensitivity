...
settings.version = 'IDS-MOO'
settings.name = '40cm_cross'
...
settings.aperture_radius = 0.2  # aperture radius in meters (2.5 meter primary = 1.25m radius)
settings.f_number = 2.5  #

settings.edge_db = 10   # edge taper on primary mirror in dB.  can be calculated later from pixel sizes.
...
settings.sky_area = 41253*0.75 # deg (full sky)
...
settings.elements_path = os.path.join(settings.base_path,
                 #'inputs/15cm_MOO.csv')  # all telescope surfaces, lenses, etc.
				 'inputs/40cm_MOO.csv')  # all telescope surfaces, lenses, etc.
                 # 'inputs/XXcm_IDS_Aug2018.csv')  # all telescope surfaces, lenses, etc.
...
settings.bands_path = os.path.join(settings.base_path,
                 #'inputs/bands_IDS-MOO_2color_220-320_270-370.csv')  # csv of bands.
				 'inputs/bands_IDS-MOO_180_and_2color_220-320_270-370.csv')  # csv of bands.
