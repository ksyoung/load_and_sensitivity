...
settings.aperture_radius = 1.5  # aperture radius in meters (2.5 meter primary = 1.25m radius)
settings.f_number = 2.  # 
...
settings.use_D_px = False ## use D_px from bands.csv import Only works if MCP = True and mult_bands = True
...
settings.elements_path = os.path.join(settings.base_path,
                 'inputs/Jacques_test.csv')  # all telescope surfaces, lenses, etc.
...
settings.bands_path = os.path.join(settings.base_path,
                 'inputs/Jacques_test_bands.csv')  # csv of bands.
