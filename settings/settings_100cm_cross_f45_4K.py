...
settings.version = 'cross_f45_4K'
settings.name = '140cm_cross_f45_4K'
...
settings.elements_path = os.path.join(settings.base_path,
                 'inputs/140cm_cross_dragone_Qi_4K.csv')  # all telescope surfaces, lenses, etc.
